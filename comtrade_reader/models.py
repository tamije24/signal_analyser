...
class File(models.Model):
    ...
    resampled_frequency = models.PositiveSmallIntegerField(null=True, default=0)
    ...
    in_channel = models.CharField(max_length=50,null=False, default="")
    ...
    d5_channel = models.CharField(max_length=50,null=False, default="")
    d6_channel = models.CharField(max_length=50,null=False, default="")
    d7_channel = models.CharField(max_length=50,null=False, default="")
    d8_channel = models.CharField(max_length=50,null=False, default="")
    d9_channel = models.CharField(max_length=50,null=False, default="")
    d10_channel = models.CharField(max_length=50,null=False, default="")
    d11_channel = models.CharField(max_length=50,null=False, default="")
    d12_channel = models.CharField(max_length=50,null=False, default="")
...
class AnalogSignal(models.Model):
    ...
    ia_signal = models.DecimalField(max_digits=20, decimal_places=6)
    ib_signal = models.DecimalField(max_digits=20, decimal_places=6)
    ic_signal = models.DecimalField(max_digits=20, decimal_places=6)
    in_signal = models.DecimalField(max_digits=20, decimal_places=6, default=0)
    va_signal = models.DecimalField(max_digits=20, decimal_places=6)
    vb_signal = models.DecimalField(max_digits=20, decimal_places=6)
    vc_signal = models.DecimalField(max_digits=20, decimal_places=6)
...
class AnalogSignalResampled(models.Model):
    sample_id = models.CharField(max_length=30, primary_key=True)
    file = models.ForeignKey(File, on_delete=models.CASCADE,  related_name='analog_signals_resampled')  
    time_signal = models.DecimalField(max_digits=8, decimal_places=6)  
    ...
    in_signal = models.DecimalField(max_digits=12, decimal_places=6, default=0)
...
class DigitalSignalResampled(models.Model):
    sample_id = models.CharField(max_length=30, primary_key=True)
    file = models.ForeignKey(File, on_delete=models.CASCADE,  related_name='digital_signals_resampled')  
    time_signal = models.DecimalField(max_digits=8, decimal_places=6)
    d1_signal = models.PositiveSmallIntegerField(default=0)
    d2_signal = models.PositiveSmallIntegerField(default=0)
    d3_signal = models.PositiveSmallIntegerField(default=0)
